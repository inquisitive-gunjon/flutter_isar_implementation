...
extension ItemQueryFilter on QueryBuilder<Item, Item, QFilterCondition> {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> numberEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'number',
        value: value,
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> numberGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> numberLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> numberBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ItemQuerySortBy on QueryBuilder<Item, Item, QSortBy> {
  ...
  QueryBuilder<Item, Item, QAfterSortBy> sortByNumber() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'number', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> sortByNumberDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemQuerySortThenBy on QueryBuilder<Item, Item, QSortThenBy> {
  ...
  QueryBuilder<Item, Item, QAfterSortBy> thenByNumber() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'number', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> thenByNumberDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'number', Sort.desc);
    });
  }
...
extension ItemQueryWhereDistinct on QueryBuilder<Item, Item, QDistinct> {
  ...
  QueryBuilder<Item, Item, QDistinct> distinctByNumber() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemQueryProperty on QueryBuilder<Item, Item, QQueryProperty> {
  ...
  QueryBuilder<Item, int, QQueryOperations> numberProperty() {
    return QueryBuilder.apply(this, (query) {
